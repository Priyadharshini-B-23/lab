                ...
                <AppBar position="static">
                    <Toolbar>
                        ...
                        <div>
                            ...
                            <Button variant="contained" color="secondary" onClick={navigateToSignupModule}>
                                SignUp
                            </Button>
                        </div>
                        <div>
                            &nbsp;
                            <Button variant="contained" color="success" onClick={navigateToLogin}>
                                SignIn
                            </Button>
